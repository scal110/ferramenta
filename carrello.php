...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Carrello || Ferramenta SBP</title>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        <?php
          ...
          echo '<tr>';
          echo '<td colspan="4" align="right"><a href="update-cart.php?action=empty" class="button alert">Empty Cart</a>&nbsp;<a href="prodotti.php" class="button [secondary success alert]">Continue Shopping</a>';
          ...
          echo "Non ci sono articoli nel tuo carrello";
        }
