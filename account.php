...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Account || BOLT Sports Shop</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <!-- Right Nav Section -->
        <ul class="right">
          ...
          <li><a href="ordini.php">Miei ordini</a></li>
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        <p><?php echo '<h3>Ciao ' .$_SESSION['fname'] .'</h3>'; ?></p>

        <p><h4>Dettagli Account</h4></p>
        ...
        <div class="small-12">
            ...
            <div class="small-8 columns end">
              <?php
                ...
                if($result) {
                  ...
                  echo '<label for="right-label" class="right inline">Cognome</label>';
                  echo '</div>';
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">Indirizzo</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">Città</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">Cap</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" value="Aggiorna" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
              <input type="reset" id="right-label" value="Resetta" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
            </div>
          </div>
        </div>
      </div>
